...
run_fresh_install_test() {
  ...
  assert_file_contains "$target/.ai-context/manifest.json" '"version": "0.4.0"'
...
EOF
  ...
  assert_file_contains "$target/.ai-context/manifest.json" '"previous_version": "0.4.0"'
...
run_version_and_dry_run_test() {
  ...
  assert_contains 'version=0.4.0' "$version_output"
